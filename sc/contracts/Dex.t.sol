...
contract DexTest is Test {
    ...
    function setUp() public {
        ...
        vm.prank(userAddress);
        router.addLiquidityETH{value: 100 ether}(address(token), 100 ether, 0, 0, userAddress, block.timestamp + 1000);
    }
    ...
    function test_setToPrice() public {
        ...
        vm.prank(userAddress);
        dex.setToPrice{value: 100 ether}(
            address(router), address(token), getCurrentPrice * 2, 1, 1, block.timestamp, block.timestamp + 1000
        );
    ...
    function test_fork() public {
        uint256 price =
            dex.getCurrentPrice(address(router), address(0xe4646147e52E914144f6010a736FFE019B549f94), router.WETH());

        vm.prank(address(0x10d994E0a8d3864062DF68a6dEDEaeCe423F25f1));
        dex.setToPrice{value: 10 ether}(
            address(router),
            address(0xe4646147e52E914144f6010a736FFE019B549f94),
            price + 10,
            1,
            1,
            block.timestamp,
        ...
        uint256 newPrice = Dex(payable(0x1a4aE924FCd29a7b0d071dbEc527A476dBb33299)).getCurrentPrice(
            address(router), address(0xe4646147e52E914144f6010a736FFE019B549f94), router.WETH()
        );
